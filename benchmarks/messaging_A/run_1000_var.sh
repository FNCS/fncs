...
$ECHO "$BLD/fncs_broker > $BROKER_OUT 1001 &"
$BLD/fncs_broker > $BROKER_OUT 1001 &

$ECHO "FNCS_CONFIG_FILE=t1000.zpl $BLD/benchmarks/bencher2 1000s 5 2 16 > $T_OUT &"
FNCS_CONFIG_FILE=t1000.zpl $BLD/benchmarks/bencher2 1000s 5 2 16 > $T_OUT &
