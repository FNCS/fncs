...
do
    ...
    $ECHO "FNCS_CONFIG_FILE=d_5_5.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 5 16 > $OUT &"
    FNCS_CONFIG_FILE=d_5_5.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 5 16 > $OUT &
done
