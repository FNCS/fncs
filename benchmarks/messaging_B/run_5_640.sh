...
do
    ...
    $ECHO "FNCS_CONFIG_FILE=d_5_640.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 640 16 > $OUT &"
    FNCS_CONFIG_FILE=d_5_640.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 640 16 > $OUT &
done
