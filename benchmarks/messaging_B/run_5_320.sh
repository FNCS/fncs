...
do
    ...
    $ECHO "FNCS_CONFIG_FILE=d_5_320.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 320 16 > $OUT &"
    FNCS_CONFIG_FILE=d_5_320.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 320 16 > $OUT &
done
