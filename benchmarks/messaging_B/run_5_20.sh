...
do
    ...
    $ECHO "FNCS_CONFIG_FILE=d_5_20.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 20 16 > $OUT &"
    FNCS_CONFIG_FILE=d_5_20.zpl FNCS_NAME=$NAME $BLD/benchmarks/bencher 1000 20 16 > $OUT &
done
